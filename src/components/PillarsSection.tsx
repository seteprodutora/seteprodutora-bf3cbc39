...
const PillarsSection = () => {
  return (
    <section className="py-20 md:py-24 bg-secondary" id="pilares">
      <div className="container mx-auto px-5">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground mt-3">
            Nossa metodologia proprietária para transformar talento em legado.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {pillars.map((pillar) => (
            <div 
              key={pillar.number} 
              className={`card-pillar ${pillar.highlight ? 'border-gold' : ''}`}
